                ...
                for line in file:
                    ...
                    if len(parts) == 2:
                        ...
                        if float(weight) <= maxweight and minweight < float(weight):
                            ...
                            weights.append(
                                1 / (pow(3, abs(midweight - (float(weight)))))
            ...
            for line in file:
                ...
                if len(parts) == 2:
                    ...
                    if float(weight) <= maxweight and minweight < float(weight):
                        elements.append(element)
                        weights.append(
                            1 / (pow(2.828, abs(midweight - (float(weight)))))
                        )  # Convert weight to integer
                        nweights.append(float(weight))
...
def randomizer(min, max, avg):
    ...
    while x < floatmax:
        ...
        x += 0.01
        weights.append(
            1 / (pow(5.0, abs(floatavg - (float(x)))))
        )  # Convert weight to integer
...
v = IntVar()
label = Label(
    root, text="Result will appear here", pady=30, bg="#111", font=("Arial", 22)
)
label.pack()
button = Button(
    root, text="Run", width=25, command=button_click, background="#111", fg="#FFF"
)
button.pack()
button2 = Button(
    root, text="Edit", width=25, command=button_click2, background="#111", fg="#FFF"
)
button2.pack()
Radiobutton(
    root,
...
we = Button(
    root, text="Preset", width=8, command=button_click3, background="#111", fg="#FFF"
)
we.pack(side=RIGHT)
Radiobutton(
    root,
