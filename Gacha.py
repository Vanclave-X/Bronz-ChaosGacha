...
def read_file_with_weight(
    filename, avg, min, max
):  # Creates a list of the available gacha pulls within the rarity range
    elements = []
    weights = []
    rarities = []
    descriptions = []
    ...
    with open(filename, "r") as file:
        for line in file:
            match = re.match(
                r"^(\d+)\.(\S*)\s*(.*)", line
            )  # Checks if the line starts with a number heading such as "23." or "167. "
            if match:
                ...
                weights.append(
                    1 / (pow(4, abs(avgrarity - (float(rarity)))))
...
def randomizer(min, max, avg, exponent):
    ...
    while x < floatmax:
        ...
        x += 0.1
        weights.append(
            1 / (pow(float(exponent), abs(floatavg - (float(x)))))
        )  # Convert weight to integer
...
def run_gacha(
    type, min, avg, max, pullcount
):  # type - gacha mode, min-avg-max - rarities
    elements, weights, rarities, descriptions, weightsum, chosentype = (
        read_file_with_weight(type, avg, min, max)
    )
    runcount = 0
    #    averagepull = 0
    #    averagecheck = 0
    while runcount < pullcount:
        ...
        filtered_elements = [
            elem
            for elem, val in zip(elements, rarities)
            if abs(val - raritypull) <= 0.2
        ]
        filtered_weights = [
            weight
            for weight, val in zip(weights, rarities)
            if abs(val - raritypull) <= 0.2
        ]
        filtered_descriptions = [
            description
            for description, val in zip(descriptions, rarities)
            if abs(val - raritypull) <= 0.2
        ]
        ...
        print(
            f"Selected element: {selected_element} with rarity: {selected_rarity} and {round(luckpercentage, 2)}% odds"
        )
...
def open_settings():
    ...
    global scifi_button
    if (
        settings_window and settings_window.winfo_exists()
    ...
    settings_window.configure(
        background="#1f1f1f", highlightbackground="#646464", highlightthickness=3
    )
    ...
    pg_button = Button(
        ...
        text="PG Mode: Off",
        width=24,
        command=lambda: togglefilter("pgmode"),
        font=(selectedfont, 12),
        background="#111",
        fg="#FFF",
    )
    pg_button.place(x=138, y=160, in_=settings_window, anchor="center")
    familiar_button = Button(
        settings_window,
        text="Classic Familiars: Off",
        width=24,
        command=lambda: togglefilter("classicfamiliar"),
        font=(selectedfont, 12),
        background="#111",
        fg="#FFF",
    )
    ...
    scifi_button = Button(
        ...
        text="No Scifi: Off",
        width=24,
        command=lambda: togglefilter("scifi"),
        font=(selectedfont, 12),
        background="#111",
        fg="#FFF",
    )
...
copyButton = Button(
    root,
    image=copyimage,
    command=lambda: copy_description(),
    borderwidth=0,
    highlightthickness=0,
    activebackground="#1f1f1f",
)
...
copyLabel = Label(
    root, text="Copy", bg="#1f1f1f", fg="#FFF", font=(selectedfont, 12), wraplength=800
)
...
holderLabel = Label(
    root, text="Categories", bg="#212121", fg="#FFF", font=(selectedfont, 14)
)
...
abilityButton = Button(
    ...
    text="Abilities",
    compound="center",
    command=lambda: select_mode("ability"),
    background="#111",
    fg="#FFF",
    font=selectedfont,
    borderwidth=0,
...
itemButton = Button(
    ...
    text="Items",
    compound="center",
    command=lambda: select_mode("item"),
    background="#111",
    fg="#FFF",
    font=selectedfont,
    borderwidth=0,
...
traitButton = Button(
    ...
    text="Traits",
    compound="center",
    command=lambda: select_mode("trait"),
    background="#111",
    fg="#FFF",
    font=selectedfont,
    borderwidth=0,
...
skillButton = Button(
    ...
    text="Skills",
    compound="center",
    command=lambda: select_mode("skill"),
    background="#111",
    fg="#FFF",
    font=selectedfont,
    borderwidth=0,
...
familiarButton = Button(
    root,
    image=buttonimage,
    text="Familiars",
    compound="center",
    command=lambda: select_mode("familiar"),
    background="#111",
    fg="#FFF",
    font=selectedfont,
    borderwidth=0,
...
holderLabel = Label(
    root, text="Presets", bg="#212121", fg="#FFF", font=(selectedfont, 14)
)
...
bronzeButton = Button(
    ...
    text="Bronze",
    compound="center",
    command=lambda: select_preset(0),
    bg="#212121",
    font=(selectedfont, 11),
    borderwidth=0,
    activebackground="#1f1f1f",
)
...
silverButton = Button(
    ...
    text="Silver",
    compound="center",
    command=lambda: select_preset(1),
    bg="#212121",
    font=(selectedfont, 11),
    borderwidth=0,
    activebackground="#1f1f1f",
...
goldButton = Button(
    ...
    text="Gold",
    compound="center",
    command=lambda: select_preset(2),
    bg="#212121",
    font=(selectedfont, 11),
    borderwidth=0,
    activebackground="#1f1f1f",
...
platButton = Button(
    ...
    text="Platinum",
    compound="center",
    command=lambda: select_preset(3),
    bg="#212121",
    font=(selectedfont, 11),
    borderwidth=0,
    activebackground="#1f1f1f",
...
diaButton = Button(
    ...
    text="Diamond",
    compound="center",
    command=lambda: select_preset(4),
    bg="#212121",
    font=(selectedfont, 11),
    borderwidth=0,
    activebackground="#1f1f1f",
...
legendButton = Button(
    ...
    text="Legendary",
    compound="center",
    command=lambda: select_preset(5),
    bg="#212121",
    font=(selectedfont, 11),
    borderwidth=0,
    activebackground="#1f1f1f",
...
mythButton = Button(
    ...
    text="Mythical",
    compound="center",
    command=lambda: select_preset(6),
    bg="#212121",
    font=(selectedfont, 11),
    borderwidth=0,
    activebackground="#1f1f1f",
...
divineButton = Button(
    ...
    text="Divine",
    compound="center",
    command=lambda: select_preset(7),
    bg="#212121",
    font=(selectedfont, 11),
    borderwidth=0,
    activebackground="#1f1f1f",
...
selectedLabel = Label(
    root, text="Current: Bronze", bg="#212121", fg="#FFF", font=(selectedfont, 12)
)
